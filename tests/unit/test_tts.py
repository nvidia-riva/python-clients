...
from nemotronspeech.client import AudioEncoding
...
@patch("nemotronspeech.client.proto.nemotron_tts_pb2_grpc.RivaSpeechSynthesisStub.__init__", riva_tts_stub_init_patch)
